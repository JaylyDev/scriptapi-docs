...
[Script API - v1.26.10](../../../packages.md) / [@minecraft/server](../README-1.md) / EntitySwingSource

# Enumeration: EntitySwingSource

Enumerator describing the source of an Entity swing. Sent as
part of [PlayerSwingStartAfterEvent](../classes/PlayerSwingStartAfterEvent-1.md)
