...
[Script API - v1.26.10](../../../packages.md) / [@minecraft/server](../README-1.md) / WaypointTextureBounds
...
> **texture**: [`WaypointTexture`](../enumerations/WaypointTexture.md)

#### Remarks

The [WaypointTexture](../enumerations/WaypointTexture.md) to display within this distance
range.
