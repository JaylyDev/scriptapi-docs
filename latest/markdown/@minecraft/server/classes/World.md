...
[Script API - v1.26.10](../../../packages.md) / [@minecraft/server](../README.md) / World
...
> `readonly` **beforeEvents**: [`WorldBeforeEvents`](WorldBeforeEvents.md)
...
> `readonly` **gameRules**: [`GameRules`](GameRules.md)
...
> `readonly` **scoreboard**: [`Scoreboard`](Scoreboard.md)
...
> `readonly` **structureManager**: [`StructureManager`](StructureManager.md)

#### Remarks

Returns the manager for [Structure](Structure.md) related APIs.
...
> `readonly` **tickingAreaManager**: [`TickingAreaManager`](TickingAreaManager.md)
...
> **getAllPlayers**(): [`Player`](Player.md)[]
...
> **getDefaultSpawnLocation**(): [`Vector3`](../interfaces/Vector3.md)
...
> **getDifficulty**(): [`Difficulty`](../enumerations/Difficulty.md)
...
> **getDimension**(`dimensionId`): [`Dimension`](Dimension.md)
...
> **getLootTableManager**(): [`LootTableManager`](LootTableManager.md)
...
> **getMoonPhase**(): [`MoonPhase`](../enumerations/MoonPhase.md)
