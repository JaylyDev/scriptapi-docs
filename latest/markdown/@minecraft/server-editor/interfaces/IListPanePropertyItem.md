...
[Script API - v1.26.10](../../../packages.md) / [@minecraft/server-editor](../README.md) / IListPanePropertyItem
...
> `readonly` **viewControlPane**: [`IListPaneViewControlPane`](IListPaneViewControlPane.md) \| `undefined`
...
> **buildViewControl**(`options`): [`IListPaneViewControlPane`](IListPaneViewControlPane.md)
