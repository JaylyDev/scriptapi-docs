...
[Script API - v1.26.10](../../packages.md) / @minecraft/server-graphics
...
```
### Installation
Install type definition for `@minecraft/server-graphics` module using npm:
```bash
npm i @minecraft/server-graphics@1.0.0-beta.1.26.10-stable
```
...
- [Atmospherics](classes/Atmospherics.md)

## Variables

- [atmosphere](variables/atmosphere.md)
