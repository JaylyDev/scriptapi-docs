...
[Script API - v1.26.10](../../packages.md) / @minecraft/server-net
...
```bash
npm i @minecraft/server-net@1.0.0-beta.1.26.10-stable
```
...
- [HttpRequestBodyTooLargeError](classes/HttpRequestBodyTooLargeError.md)
- [HttpRequestLimitExceededError](classes/HttpRequestLimitExceededError.md)
- [HttpRequestNotAllowedError](classes/HttpRequestNotAllowedError.md)
- [HttpResponse](classes/HttpResponse.md)
- [HttpsOnlyError](classes/HttpsOnlyError.md)
