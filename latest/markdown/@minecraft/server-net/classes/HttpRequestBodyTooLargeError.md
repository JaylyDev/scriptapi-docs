...
[Script API - v1.26.10](../../../packages.md) / [@minecraft/server-net](../README.md) / HttpRequestBodyTooLargeError
...
> `private` **new HttpRequestBodyTooLargeError**(): `HttpRequestBodyTooLargeError`
