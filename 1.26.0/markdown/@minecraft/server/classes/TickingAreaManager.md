...
[Script API - v1.26.0](../../../packages.md) / [@minecraft/server](../README-1.md) / TickingAreaManager
...
> **createTickingArea**(`identifier`, `options`): `Promise`\<[`TickingArea`](../interfaces/TickingArea.md)\>
...
`Promise`\<[`TickingArea`](../interfaces/TickingArea.md)\>
