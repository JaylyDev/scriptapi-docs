...
[Script API - v1.26.0](../../../packages.md) / [@minecraft/server-editor-private-bindings](../README.md) / CursorProperties
...
> `optional` **controlMode?**: [`CursorControlMode`](../enumerations/CursorControlMode.md)
...
> `optional` **fillColor?**: [`RGBA`](../../server/interfaces/RGBA.md)

***

### fixedModeDistance?

> `optional` **fixedModeDistance?**: `number`
...
> `optional` **projectThroughLiquid?**: `boolean`

***

### targetMode?

> `optional` **targetMode?**: [`CursorTargetMode`](../enumerations/CursorTargetMode.md)
