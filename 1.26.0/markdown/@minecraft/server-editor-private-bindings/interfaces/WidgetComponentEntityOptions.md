...
[Script API - v1.26.0](../../../packages.md) / [@minecraft/server-editor-private-bindings](../README.md) / WidgetComponentEntityOptions
...
> `optional` **deselectedAnimation?**: `string`
...
> `optional` **selectedAnimation?**: `string`
