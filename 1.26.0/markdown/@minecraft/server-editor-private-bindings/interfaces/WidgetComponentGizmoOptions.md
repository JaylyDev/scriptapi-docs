...
[Script API - v1.26.0](../../../packages.md) / [@minecraft/server-editor-private-bindings](../README.md) / WidgetComponentGizmoOptions
...
> `optional` **axes?**: [`Axis`](../enumerations/Axis.md)
...
> `optional` **normalizedAutoOffset?**: [`Vector3`](../../server/interfaces/Vector3.md)
