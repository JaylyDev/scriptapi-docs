...
[Script API - v1.26.0](../../../packages.md) / [@minecraft/server-editor-private-bindings](../README.md) / WidgetComponentVolumeOutlineOptions
...
> `optional` **highlightHullColor?**: [`RGBA`](../../server/interfaces/RGBA.md)

***

### highlightOutlineColor?

> `optional` **highlightOutlineColor?**: [`RGBA`](../../server/interfaces/RGBA.md)
...
> `optional` **showHighlightOutline?**: `boolean`
...
> `optional` **volumeOffset?**: [`Vector3`](../../server/interfaces/Vector3.md)
