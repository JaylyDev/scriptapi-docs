...
[Script API - v1.26.0](../../../packages.md) / [@minecraft/server-editor-private-bindings](../README.md) / WidgetComponentGridOptions
...
> `optional` **gridCount?**: [`Vector2`](../../server/interfaces/Vector2.md)

***

### gridSize?

> `optional` **gridSize?**: [`Vector2`](../../server/interfaces/Vector2.md)
...
> `optional` **plane?**: [`Plane`](../enumerations/Plane.md)
