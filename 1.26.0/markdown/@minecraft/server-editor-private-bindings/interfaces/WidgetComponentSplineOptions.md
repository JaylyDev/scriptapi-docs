...
[Script API - v1.26.0](../../../packages.md) / [@minecraft/server-editor-private-bindings](../README.md) / WidgetComponentSplineOptions
...
> **controlPoints**: [`Widget`](../classes/Widget.md)[]
...
> `optional` **splineType?**: [`SplineType`](../enumerations/SplineType.md)
