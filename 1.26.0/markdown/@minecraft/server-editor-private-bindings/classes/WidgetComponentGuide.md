...
[Script API - v1.26.0](../../../packages.md) / [@minecraft/server-editor-private-bindings](../README.md) / WidgetComponentGuide

# Class: WidgetComponentGuide
...
> `private` **new WidgetComponentGuide**(): `WidgetComponentGuide`
