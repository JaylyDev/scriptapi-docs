...
[Script API - v1.26.0](../../../packages.md) / [@minecraft/server-editor-private-bindings](../README.md) / WidgetComponentEntity

# Class: WidgetComponentEntity
...
> `private` **new WidgetComponentEntity**(): `WidgetComponentEntity`
