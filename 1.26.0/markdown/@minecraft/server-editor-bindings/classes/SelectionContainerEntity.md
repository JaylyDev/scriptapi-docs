...
[Script API - v1.26.0](../../../packages.md) / [@minecraft/server-editor-bindings](../README.md) / SelectionContainerEntity
...
> `private` **new SelectionContainerEntity**(): `SelectionContainerEntity`
