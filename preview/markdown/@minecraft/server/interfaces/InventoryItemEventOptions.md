...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / InventoryItemEventOptions
...
> `optional` **inventoryType?**: [`PlayerInventoryType`](../enumerations/PlayerInventoryType.md)
