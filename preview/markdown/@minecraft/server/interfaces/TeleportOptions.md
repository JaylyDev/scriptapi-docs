...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / TeleportOptions
...
> `optional` **dimension?**: [`Dimension`](../classes/Dimension.md)
...
> `optional` **facingLocation?**: [`Vector3`](Vector3.md)
...
> `optional` **rotation?**: [`Vector2`](Vector2.md)
