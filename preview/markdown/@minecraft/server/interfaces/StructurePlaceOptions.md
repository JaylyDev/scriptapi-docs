...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / StructurePlaceOptions

# Interface: StructurePlaceOptions

Provides additional options for [StructureManager.place](../classes/StructureManager.md#place)
...
> `optional` **animationMode?**: [`StructureAnimationMode`](../enumerations/StructureAnimationMode.md)
...
> `optional` **mirror?**: [`StructureMirrorAxis`](../enumerations/StructureMirrorAxis.md)
...
> `optional` **rotation?**: [`StructureRotation`](../enumerations/StructureRotation.md)
