...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / CustomCommand
...
> `optional` **mandatoryParameters?**: [`CustomCommandParameter`](CustomCommandParameter.md)[]
...
> `optional` **optionalParameters?**: [`CustomCommandParameter`](CustomCommandParameter.md)[]
...
> **permissionLevel**: [`CommandPermissionLevel`](../enumerations/CommandPermissionLevel.md)
