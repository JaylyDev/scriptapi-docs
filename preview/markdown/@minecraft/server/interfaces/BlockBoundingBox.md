...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / BlockBoundingBox
...
created using the associated @minecraft/server.BlockBoundingBoxUtils utility functions.
...
( 0,0,0 ) -> ( 0,0,0 )
has a size of ( 0,0,0 ) (unlike the very similar [BlockVolume](../classes/BlockVolume.md) object)
...
A [Vector3](Vector3.md) that represents the largest corner of the
rectangle
...
A [Vector3](Vector3.md) that represents the smallest corner of the
rectangle
