...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / InputEventOptions

# Interface: InputEventOptions

An interface that is passed into [PlayerButtonInputAfterEventSignal.subscribe](../classes/PlayerButtonInputAfterEventSignal.md#subscribe) that filters
