...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / CameraFixedBoomOptions
...
> `optional` **entityOffset?**: [`Vector3`](Vector3.md)
...
> `optional` **viewOffset?**: [`Vector2`](Vector2.md)
