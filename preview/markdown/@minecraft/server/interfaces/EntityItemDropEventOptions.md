...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / EntityItemDropEventOptions

# Interface: EntityItemDropEventOptions

An interface that is passed into [EntityItemDropAfterEventSignal.subscribe](../classes/EntityItemDropAfterEventSignal.md#subscribe) that filters out
