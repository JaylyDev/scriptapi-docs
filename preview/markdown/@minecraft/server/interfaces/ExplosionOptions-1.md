...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / ExplosionOptions

# Interface: ExplosionOptions

Additional configuration options for the [Dimension.createExplosion](../classes/Dimension-1.md#createexplosion) method.
...
> `optional` **source?**: [`Entity`](../classes/Entity-1.md)
