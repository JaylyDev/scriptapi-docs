...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / TickingAreaOptions

# Interface: TickingAreaOptions

Options to create a ticking area using the [TickingAreaManager](../classes/TickingAreaManager.md).
