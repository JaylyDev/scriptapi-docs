...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityColorComponent
...
> `private` **new EntityColorComponent**(): `EntityColorComponent`
...
> `readonly` `static` **componentId**: `"minecraft:color"` = `'minecraft:color'`
