...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityIsHiddenWhenInvisibleComponent
...
> `private` **new EntityIsHiddenWhenInvisibleComponent**(): `EntityIsHiddenWhenInvisibleComponent`
...
> `readonly` `static` **componentId**: `"minecraft:is_hidden_when_invisible"` = `'minecraft:is_hidden_when_invisible'`
