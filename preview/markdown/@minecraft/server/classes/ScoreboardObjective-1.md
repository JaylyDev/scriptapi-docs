...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / ScoreboardObjective
...
`string` \| [`Entity`](Entity-1.md) \| [`ScoreboardIdentity`](ScoreboardIdentity-1.md)
...
> **getScores**(): [`ScoreboardScoreInfo`](ScoreboardScoreInfo-1.md)[]

#### Returns

[`ScoreboardScoreInfo`](ScoreboardScoreInfo-1.md)[]
