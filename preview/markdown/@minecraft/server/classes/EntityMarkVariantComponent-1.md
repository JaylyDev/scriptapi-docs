...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityMarkVariantComponent
...
> `private` **new EntityMarkVariantComponent**(): `EntityMarkVariantComponent`
...
> `readonly` `static` **componentId**: `"minecraft:mark_variant"` = `'minecraft:mark_variant'`
