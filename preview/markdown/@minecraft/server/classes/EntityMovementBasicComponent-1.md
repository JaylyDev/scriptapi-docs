...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityMovementBasicComponent
...
> `private` **new EntityMovementBasicComponent**(): `EntityMovementBasicComponent`
...
> `readonly` `static` **componentId**: `"minecraft:movement.basic"` = `'minecraft:movement.basic'`
