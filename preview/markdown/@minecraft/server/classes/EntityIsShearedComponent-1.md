...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityIsShearedComponent
...
> `private` **new EntityIsShearedComponent**(): `EntityIsShearedComponent`
...
> `readonly` `static` **componentId**: `"minecraft:is_sheared"` = `'minecraft:is_sheared'`
