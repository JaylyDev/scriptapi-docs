...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / ScoreboardIdentity
...
> `readonly` **type**: [`ScoreboardIdentityType`](../enumerations/ScoreboardIdentityType-1.md)
...
> **getEntity**(): [`Entity`](Entity-1.md) \| `undefined`
