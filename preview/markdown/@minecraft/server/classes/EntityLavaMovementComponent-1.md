...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityLavaMovementComponent
...
> `private` **new EntityLavaMovementComponent**(): `EntityLavaMovementComponent`
...
> `readonly` `static` **componentId**: `"minecraft:lava_movement"` = `'minecraft:lava_movement'`
