...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / LootPool
...
> `readonly` **entries**: [`LootPoolEntry`](LootPoolEntry-1.md)[]
...
> `readonly` `optional` **tiers?**: [`LootPoolTiers`](LootPoolTiers-1.md)
