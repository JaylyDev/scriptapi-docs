...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityNavigationGenericComponent
...
> `private` **new EntityNavigationGenericComponent**(): `EntityNavigationGenericComponent`
...
> `readonly` `static` **componentId**: `"minecraft:navigation.generic"` = `'minecraft:navigation.generic'`
