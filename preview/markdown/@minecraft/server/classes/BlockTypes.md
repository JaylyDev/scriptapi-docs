...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / BlockTypes
...
> `static` **get**(`typeName`): [`BlockType`](BlockType.md) \| `undefined`
...
[`BlockType`](BlockType.md) \| `undefined`
...
> `static` **getAll**(): [`BlockType`](BlockType.md)[]
