...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / TickingAreaManager
...
[`TickingAreaOptions`](../interfaces/TickingAreaOptions-1.md)
...
[TickingAreaError](TickingAreaError-1.md)
...
> **getAllTickingAreas**(): [`TickingArea`](../interfaces/TickingArea-1.md)[]

#### Returns

[`TickingArea`](../interfaces/TickingArea-1.md)[]
...
> **getTickingArea**(`identifier`): [`TickingArea`](../interfaces/TickingArea-1.md) \| `undefined`

#### Parameters

##### identifier

`string` \| [`TickingArea`](../interfaces/TickingArea-1.md)

#### Returns

[`TickingArea`](../interfaces/TickingArea-1.md) \| `undefined`
