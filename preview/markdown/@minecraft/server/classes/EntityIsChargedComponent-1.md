...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityIsChargedComponent
...
> `private` **new EntityIsChargedComponent**(): `EntityIsChargedComponent`
...
> `readonly` `static` **componentId**: `"minecraft:is_charged"` = `'minecraft:is_charged'`
