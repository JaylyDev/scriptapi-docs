...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / Container
...
> `readonly` `optional` **containerRules?**: [`ContainerRules`](../interfaces/ContainerRules-1.md)
...
Won't throw [ContainerRules](../interfaces/ContainerRules-1.md) error for over weight
...
> **getItem**(`slot`): [`ItemStack`](ItemStack-1.md) \| `undefined`
...
Gets an [ItemStack](ItemStack-1.md) of the item at the specified slot.
...
> **getSlot**(`slot`): [`ContainerSlot`](ContainerSlot-1.md)
...
> **transferItem**(`fromSlot`, `toContainer`): [`ItemStack`](ItemStack-1.md) \| `undefined`
