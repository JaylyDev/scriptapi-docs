...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / PlayerInputPermissionCategoryChangeAfterEvent
...
> `readonly` **category**: [`InputPermissionCategory`](../enumerations/InputPermissionCategory.md)
