...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / WorldAfterEvents
...
> `readonly` **blockContainerClosed**: [`BlockContainerClosedAfterEventSignal`](BlockContainerClosedAfterEventSignal.md)
...
> `readonly` **blockContainerOpened**: [`BlockContainerOpenedAfterEventSignal`](BlockContainerOpenedAfterEventSignal.md)
...
> `readonly` **entityContainerClosed**: [`EntityContainerClosedAfterEventSignal`](EntityContainerClosedAfterEventSignal.md)
...
> `readonly` **entityContainerOpened**: [`EntityContainerOpenedAfterEventSignal`](EntityContainerOpenedAfterEventSignal.md)
...
> `readonly` **entityHeal**: [`EntityHealAfterEventSignal`](EntityHealAfterEventSignal-1.md)
...
> `readonly` **entityItemDrop**: [`EntityItemDropAfterEventSignal`](EntityItemDropAfterEventSignal-1.md)
...
> `readonly` **entityItemPickup**: [`EntityItemPickupAfterEventSignal`](EntityItemPickupAfterEventSignal-1.md)
