...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / ItemDyeableComponent
...
> `optional` **color?**: [`RGB`](../interfaces/RGB.md)
...
> `readonly` `optional` **defaultColor?**: [`RGB`](../interfaces/RGB.md)
