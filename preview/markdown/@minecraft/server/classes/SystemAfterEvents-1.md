...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / SystemAfterEvents
...
> `readonly` **scriptEventReceive**: [`ScriptEventCommandMessageAfterEventSignal`](ScriptEventCommandMessageAfterEventSignal-1.md)
