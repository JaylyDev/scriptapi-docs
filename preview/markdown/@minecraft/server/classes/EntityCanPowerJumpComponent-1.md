...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityCanPowerJumpComponent
...
> `private` **new EntityCanPowerJumpComponent**(): `EntityCanPowerJumpComponent`
...
> `readonly` `static` **componentId**: `"minecraft:can_power_jump"` = `'minecraft:can_power_jump'`
