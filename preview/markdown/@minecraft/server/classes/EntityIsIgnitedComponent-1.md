...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityIsIgnitedComponent
...
> `private` **new EntityIsIgnitedComponent**(): `EntityIsIgnitedComponent`
...
> `readonly` `static` **componentId**: `"minecraft:is_ignited"` = `'minecraft:is_ignited'`
