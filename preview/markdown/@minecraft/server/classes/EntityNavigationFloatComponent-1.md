...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityNavigationFloatComponent
...
> `private` **new EntityNavigationFloatComponent**(): `EntityNavigationFloatComponent`
...
> `readonly` `static` **componentId**: `"minecraft:navigation.float"` = `'minecraft:navigation.float'`
