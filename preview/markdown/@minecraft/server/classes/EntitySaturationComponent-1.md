...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntitySaturationComponent

# Class: EntitySaturationComponent
...
> `private` **new EntitySaturationComponent**(): `EntitySaturationComponent`
...
> `readonly` `static` **componentId**: `"minecraft:player.saturation"` = `'minecraft:player.saturation'`
