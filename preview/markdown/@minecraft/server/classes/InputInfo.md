...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / InputInfo
...
> `readonly` **lastInputModeUsed**: [`InputMode`](../enumerations/InputMode.md)
...
> **getButtonState**(`button`): [`ButtonState`](../enumerations/ButtonState.md)
...
> **getMovementVector**(): [`Vector2`](../interfaces/Vector2.md)
