...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / AimAssistRegistry
...
> **addCategory**(`category`): [`AimAssistCategory`](AimAssistCategory-1.md)

#### Parameters

##### category

[`AimAssistCategorySettings`](AimAssistCategorySettings-1.md)

The category settings used to create the new category.

#### Returns

[`AimAssistCategory`](AimAssistCategory-1.md)
...
> **addPreset**(`preset`): [`AimAssistPreset`](AimAssistPreset-1.md)

#### Parameters

##### preset

[`AimAssistPresetSettings`](AimAssistPresetSettings-1.md)

The preset settings used to create the new preset.

#### Returns

[`AimAssistPreset`](AimAssistPreset-1.md)
...
> **getCategories**(): [`AimAssistCategory`](AimAssistCategory-1.md)[]
...
> **getCategory**(`categoryId`): [`AimAssistCategory`](AimAssistCategory-1.md) \| `undefined`
...
[`AimAssistCategory`](AimAssistCategory-1.md) \| `undefined`
...
> **getPreset**(`presetId`): [`AimAssistPreset`](AimAssistPreset-1.md) \| `undefined`
...
[`AimAssistPreset`](AimAssistPreset-1.md) \| `undefined`
...
> **getPresets**(): [`AimAssistPreset`](AimAssistPreset-1.md)[]
