...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / ItemStack
...
> **lockMode**: [`ItemLockMode`](../enumerations/ItemLockMode-1.md)
...
> `readonly` **type**: [`ItemType`](ItemType-1.md)
...
> **getComponent**\<`T`\>(`componentId`): [`ItemComponentReturnType`](../type-aliases/ItemComponentReturnType-1.md)\<`T`\> \| `undefined`
...
Available component IDs are those in the [ItemComponentTypes](../enumerations/ItemComponentTypes-1.md) enum and custom component IDs registered
with the [ItemComponentRegistry](ItemComponentRegistry-1.md).

#### Returns

[`ItemComponentReturnType`](../type-aliases/ItemComponentReturnType-1.md)\<`T`\> \| `undefined`
...
> **getComponents**(): [`ItemComponent`](ItemComponent-1.md)[]
...
> **getRawLore**(): [`RawMessage`](../interfaces/RawMessage-1.md)[]
...
Returns the lore value - a secondary display string - for an
ItemStack. String lore lines will be converted to a [RawMessage](../interfaces/RawMessage-1.md) and put under [RawMessage.text](../interfaces/RawMessage-1.md#text).
