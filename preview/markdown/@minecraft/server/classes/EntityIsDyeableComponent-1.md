...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityIsDyeableComponent
...
> `private` **new EntityIsDyeableComponent**(): `EntityIsDyeableComponent`
...
> `readonly` `static` **componentId**: `"minecraft:is_dyeable"` = `'minecraft:is_dyeable'`
