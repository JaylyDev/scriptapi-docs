...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / ItemEnchantableComponent
...
> `readonly` **slots**: [`EnchantmentSlot`](../enumerations/EnchantmentSlot-1.md)[]
...
[EnchantmentLevelOutOfBoundsError](EnchantmentLevelOutOfBoundsError-1.md)

[EnchantmentTypeNotCompatibleError](EnchantmentTypeNotCompatibleError-1.md)

[EnchantmentTypeUnknownIdError](EnchantmentTypeUnknownIdError-1.md)
...
> **getEnchantment**(`enchantmentType`): [`Enchantment`](../interfaces/Enchantment-1.md) \| `undefined`

#### Parameters

##### enchantmentType

`string` \| [`EnchantmentType`](EnchantmentType-1.md)

The enchantment type to get.

#### Returns

[`Enchantment`](../interfaces/Enchantment-1.md) \| `undefined`
...
> **getEnchantments**(): [`Enchantment`](../interfaces/Enchantment-1.md)[]
