...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityIsChestedComponent
...
> `private` **new EntityIsChestedComponent**(): `EntityIsChestedComponent`
...
> `readonly` `static` **componentId**: `"minecraft:is_chested"` = `'minecraft:is_chested'`
