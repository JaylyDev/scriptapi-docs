...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / BlockInventoryComponent
...
> `readonly` `optional` **container?**: [`Container`](Container-1.md)

#### Remarks

The container which holds an [ItemStack](ItemStack-1.md).
