...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / Effect
...
effect. There are 20 ticks per second. Use [TicksPerSecond](../variables/TicksPerSecond-1.md) constant to convert between ticks and
seconds.
