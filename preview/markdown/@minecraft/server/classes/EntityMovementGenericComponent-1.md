...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityMovementGenericComponent
...
> `private` **new EntityMovementGenericComponent**(): `EntityMovementGenericComponent`
...
> `readonly` `static` **componentId**: `"minecraft:movement.generic"` = `'minecraft:movement.generic'`
