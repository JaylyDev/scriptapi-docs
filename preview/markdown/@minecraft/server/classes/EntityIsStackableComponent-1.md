...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityIsStackableComponent
...
> `private` **new EntityIsStackableComponent**(): `EntityIsStackableComponent`
...
> `readonly` `static` **componentId**: `"minecraft:is_stackable"` = `'minecraft:is_stackable'`
