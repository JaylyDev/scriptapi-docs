...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityIsTamedComponent
...
> `private` **new EntityIsTamedComponent**(): `EntityIsTamedComponent`
...
> `readonly` `static` **componentId**: `"minecraft:is_tamed"` = `'minecraft:is_tamed'`
