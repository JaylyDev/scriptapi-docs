...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / EntityAgeableComponent
...
> `readonly` **growUp**: [`Trigger`](Trigger.md)
...
> **getFeedItems**(): [`EntityDefinitionFeedItem`](EntityDefinitionFeedItem.md)[]
