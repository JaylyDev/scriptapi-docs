...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityUnderwaterMovementComponent
...
> `private` **new EntityUnderwaterMovementComponent**(): `EntityUnderwaterMovementComponent`
...
> `readonly` `static` **componentId**: `"minecraft:underwater_movement"` = `'minecraft:underwater_movement'`
