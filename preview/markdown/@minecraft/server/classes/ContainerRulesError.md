...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / ContainerRulesError
...
> `readonly` **reason**: [`ContainerRulesErrorReason`](../enumerations/ContainerRulesErrorReason.md)
