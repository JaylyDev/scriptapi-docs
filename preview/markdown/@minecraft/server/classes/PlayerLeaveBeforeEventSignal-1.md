...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / PlayerLeaveBeforeEventSignal
...
> `private` **new PlayerLeaveBeforeEventSignal**(): `PlayerLeaveBeforeEventSignal`
