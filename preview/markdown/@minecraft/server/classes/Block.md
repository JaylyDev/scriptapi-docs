...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / Block
...
> `readonly` **permutation**: [`BlockPermutation`](BlockPermutation.md)
...
> `readonly` **type**: [`BlockType`](BlockType.md)
...
> **bottomCenter**(): [`Vector3`](../interfaces/Vector3.md)
...
Returns the [Vector3](../interfaces/Vector3.md) of the center of this block on
the X and Z axis.
...
[`Water`](../enumerations/LiquidType.md#water)
...
> **center**(): [`Vector3`](../interfaces/Vector3.md)
...
> **getComponent**\<`T`\>(`componentId`): [`BlockComponentReturnType`](../type-aliases/BlockComponentReturnType.md)\<`T`\> \| `undefined`
...
in the [BlockComponentTypes](../enumerations/BlockComponentTypes.md) enum and custom component
IDs registered with the [BlockComponentRegistry](BlockComponentRegistry.md).

#### Returns

[`BlockComponentReturnType`](../type-aliases/BlockComponentReturnType.md)\<`T`\> \| `undefined`
...
> **getComponents**(): [`BlockComponent`](BlockComponent.md)[]
...
> **getItemStack**(`amount?`, `withData?`): [`ItemStack`](ItemStack.md) \| `undefined`
