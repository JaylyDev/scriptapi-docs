...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityFlyingSpeedComponent
...
> `private` **new EntityFlyingSpeedComponent**(): `EntityFlyingSpeedComponent`
...
> `readonly` `static` **componentId**: `"minecraft:flying_speed"` = `'minecraft:flying_speed'`
