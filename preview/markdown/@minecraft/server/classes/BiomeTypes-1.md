...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / BiomeTypes
...
> `static` **get**(`typeName`): [`BiomeType`](BiomeType-1.md) \| `undefined`
...
[`BiomeType`](BiomeType-1.md) \| `undefined`
...
> `static` **getAll**(): [`BiomeType`](BiomeType-1.md)[]
