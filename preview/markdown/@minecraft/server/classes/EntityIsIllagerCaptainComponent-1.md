...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityIsIllagerCaptainComponent
...
> `private` **new EntityIsIllagerCaptainComponent**(): `EntityIsIllagerCaptainComponent`
...
> `readonly` `static` **componentId**: `"minecraft:is_illager_captain"` = `'minecraft:is_illager_captain'`
