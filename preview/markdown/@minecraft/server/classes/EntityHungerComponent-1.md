...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityHungerComponent

# Class: EntityHungerComponent
...
> `private` **new EntityHungerComponent**(): `EntityHungerComponent`
...
> `readonly` `static` **componentId**: `"minecraft:player.hunger"` = `'minecraft:player.hunger'`
