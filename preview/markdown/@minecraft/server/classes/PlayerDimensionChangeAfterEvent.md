...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / PlayerDimensionChangeAfterEvent
...
> `readonly` **fromDimension**: [`Dimension`](Dimension.md)
...
> `readonly` **fromLocation**: [`Vector3`](../interfaces/Vector3.md)
...
> `readonly` **toDimension**: [`Dimension`](Dimension.md)
...
> `readonly` **toLocation**: [`Vector3`](../interfaces/Vector3.md)
