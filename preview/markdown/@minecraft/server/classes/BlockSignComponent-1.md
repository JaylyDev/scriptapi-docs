...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / BlockSignComponent
...
> **getRawText**(`side?`): [`RawText`](../interfaces/RawText-1.md) \| `undefined`
...
[`RawText`](../interfaces/RawText-1.md) \| `undefined`
...
> **getTextDyeColor**(`side?`): [`DyeColor`](../enumerations/DyeColor-1.md) \| `undefined`
...
[`DyeColor`](../enumerations/DyeColor-1.md) \| `undefined`
