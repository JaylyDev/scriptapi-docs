...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / System
...
> `readonly` **afterEvents**: [`SystemAfterEvents`](SystemAfterEvents-1.md)
...
> `readonly` **beforeEvents**: [`SystemBeforeEvents`](SystemBeforeEvents-1.md)
...
> `readonly` **serverSystemInfo**: [`SystemInfo`](SystemInfo-1.md)
