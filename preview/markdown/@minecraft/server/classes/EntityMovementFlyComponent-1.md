...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityMovementFlyComponent
...
> `private` **new EntityMovementFlyComponent**(): `EntityMovementFlyComponent`
...
> `readonly` `static` **componentId**: `"minecraft:movement.fly"` = `'minecraft:movement.fly'`
