...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / BlockLocationIterator
...
- `Iterable`\<[`Vector3`](../interfaces/Vector3.md)\>
...
> **\[iterator\]**(): `Iterator`\<[`Vector3`](../interfaces/Vector3.md)\>

#### Returns

`Iterator`\<[`Vector3`](../interfaces/Vector3.md)\>
...
> **next**(): `IteratorResult`\<[`Vector3`](../interfaces/Vector3.md)\>

#### Returns

`IteratorResult`\<[`Vector3`](../interfaces/Vector3.md)\>
