...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / Player
...
[`Entity`](Entity-1.md).[`constructor`](Entity-1.md#constructor)

## Properties

### camera

> `readonly` **camera**: [`Camera`](Camera-1.md)
...
The player's chat display name, composed from [Player.chatNamePrefix](#chatnameprefix) + [Player.name](#name) + [Player.chatNameSuffix](#chatnamesuffix). This is the name shown as the author
of chat messages sent by this player. To change the name
shown above the player's head, use [Entity.nameTag](Entity-1.md#nametag).
...
> `optional` **chatMessagePrefix?**: `string`
...
name display - use [Player.chatNamePrefix](#chatnameprefix) for the
name shown in chat, or [Entity.nameTag](Entity-1.md#nametag) for the name
...
> `optional` **chatNamePrefix?**: `string`
...
above the player's head or the player list - use [Entity.nameTag](Entity-1.md#nametag) for that. To prefix the message text itself,
use [Player.chatMessagePrefix](#chatmessageprefix). Set to undefined to
clear.
...
> `optional` **chatNameSuffix?**: `string`
...
player's name in chat messages. Does not affect the name tag
above the player's head or the player list - use [Entity.nameTag](Entity-1.md#nametag) for that. See also [Player.chatNamePrefix](#chatnameprefix). Set to undefined to clear.
...
> `readonly` **clientSystemInfo**: [`ClientSystemInfo`](ClientSystemInfo-1.md)
...
> **commandPermissionLevel**: [`CommandPermissionLevel`](../enumerations/CommandPermissionLevel-1.md)
...
[`Entity`](Entity-1.md).[`dimension`](Entity-1.md#dimension)

***

### graphicsMode

> `readonly` **graphicsMode**: [`GraphicsMode`](../enumerations/GraphicsMode-1.md)
...
property is accessible even if [Entity.isValid](Entity-1.md#isvalid) is
false.
...
[`Entity`](Entity-1.md).[`id`](Entity-1.md#id)

***

### inputInfo

> `readonly` **inputInfo**: [`InputInfo`](InputInfo-1.md)
...
> `readonly` **inputPermissions**: [`PlayerInputPermissions`](PlayerInputPermissions-1.md)
...
[`Entity`](Entity-1.md).[`isClimbing`](Entity-1.md#isclimbing)
...
[`Entity`](Entity-1.md).[`isFalling`](Entity-1.md#isfalling)
...
[`Entity`](Entity-1.md).[`isInWater`](Entity-1.md#isinwater)
...
[`Entity`](Entity-1.md).[`isOnGround`](Entity-1.md#isonground)
...
[`Entity`](Entity-1.md).[`isSleeping`](Entity-1.md#issleeping)
...
[`Entity`](Entity-1.md).[`isSneaking`](Entity-1.md#issneaking)
...
[`Entity`](Entity-1.md).[`isSprinting`](Entity-1.md#issprinting)
...
[`Entity`](Entity-1.md).[`isSwimming`](Entity-1.md#isswimming)
...
[`Entity`](Entity-1.md).[`isValid`](Entity-1.md#isvalid)
...
[`Entity`](Entity-1.md).[`localizationKey`](Entity-1.md#localizationkey)
...
[`Entity`](Entity-1.md).[`location`](Entity-1.md#location)

***

### locatorBar

> `readonly` **locatorBar**: [`LocatorBar`](LocatorBar.md)
...
[`Entity`](Entity-1.md).[`nameplateDepthTested`](Entity-1.md#nameplatedepthtested)
...
[`Entity`](Entity-1.md).[`nameplateRenderDistance`](Entity-1.md#nameplaterenderdistance)
...
[`Entity`](Entity-1.md).[`nameTag`](Entity-1.md#nametag)

***

### onScreenDisplay

> `readonly` **onScreenDisplay**: [`ScreenDisplay`](ScreenDisplay-1.md)
...
> `readonly` `optional` **partyInfo?**: [`PartyInfo`](../interfaces/PartyInfo.md)
...
> `readonly` **playerPermissionLevel**: [`PlayerPermissionLevel`](../enumerations/PlayerPermissionLevel-1.md)
...
> `readonly` `optional` **scoreboardIdentity?**: [`ScoreboardIdentity`](ScoreboardIdentity-1.md)
...
[`Entity`](Entity-1.md).[`scoreboardIdentity`](Entity-1.md#scoreboardidentity)
...
> `readonly` `optional` **target?**: [`Entity`](Entity-1.md)
...
[`Entity`](Entity-1.md).[`target`](Entity-1.md#target)
...
[Entity.isValid](Entity-1.md#isvalid) is false.
...
[`Entity`](Entity-1.md).[`typeId`](Entity-1.md#typeid)
...
> **addEffect**(`effectType`, `duration`, `options?`): [`Effect`](Effect-1.md) \| `undefined`

#### Parameters

##### effectType

`string` \| [`EffectType`](EffectType-1.md)
...
20 ticks per second. Use [TicksPerSecond](../variables/TicksPerSecond-1.md) constant to
...
[`Entity`](Entity-1.md).[`addEffect`](Entity-1.md#addeffect)
...
> **addItem**(`itemStack`): [`ItemStack`](ItemStack-1.md) \| `undefined`
...
[ContainerRulesError](ContainerRulesError-1.md)

Error

[InvalidEntityComponentError](InvalidEntityComponentError-1.md)
...
[`Entity`](Entity-1.md).[`addItem`](Entity-1.md#additem)
...
[`Entity`](Entity-1.md).[`addTag`](Entity-1.md#addtag)
...
[`EntityApplyDamageByProjectileOptions`](../interfaces/EntityApplyDamageByProjectileOptions-1.md) \| [`EntityApplyDamageOptions`](../interfaces/EntityApplyDamageOptions-1.md)
...
[`Entity`](Entity-1.md).[`applyDamage`](Entity-1.md#applydamage)
...
[`Entity`](Entity-1.md).[`applyImpulse`](Entity-1.md#applyimpulse)
...
[`Entity`](Entity-1.md).[`applyKnockback`](Entity-1.md#applyknockback)
...
[`Entity`](Entity-1.md).[`clearDynamicProperties`](Entity-1.md#cleardynamicproperties)
...
[`Entity`](Entity-1.md).[`clearVelocity`](Entity-1.md#clearvelocity)
...
[`Entity`](Entity-1.md).[`extinguishFire`](Entity-1.md#extinguishfire)

***

### getAABB()

> **getAABB**(): [`AABB`](../interfaces/AABB-1.md)
...
[`Entity`](Entity-1.md).[`getAABB`](Entity-1.md#getaabb)

***

### getAimAssist()

> **getAimAssist**(): [`PlayerAimAssist`](PlayerAimAssist-1.md)

#### Returns

[`PlayerAimAssist`](PlayerAimAssist-1.md)
...
> **getAllBlocksStandingOn**(`options?`): [`Block`](Block-1.md)[]
...
[`Entity`](Entity-1.md).[`getAllBlocksStandingOn`](Entity-1.md#getallblocksstandingon)

***

### getBlockFromViewDirection()

> **getBlockFromViewDirection**(`options?`): [`BlockRaycastHit`](../interfaces/BlockRaycastHit-1.md) \| `undefined`
...
[`Entity`](Entity-1.md).[`getBlockFromViewDirection`](Entity-1.md#getblockfromviewdirection)

***

### getBlockStandingOn()

> **getBlockStandingOn**(`options?`): [`Block`](Block-1.md) \| `undefined`
...
[`Entity`](Entity-1.md).[`getBlockStandingOn`](Entity-1.md#getblockstandingon)

***

### getComponent()

> **getComponent**\<`T`\>(`componentId`): [`EntityComponentReturnType`](../type-aliases/EntityComponentReturnType-1.md)\<`T`\> \| `undefined`
...
[EntityComponentTypes](../enumerations/EntityComponentTypes-1.md) enum.

#### Returns

[`EntityComponentReturnType`](../type-aliases/EntityComponentReturnType-1.md)\<`T`\> \| `undefined`
...
[`Entity`](Entity-1.md).[`getComponent`](Entity-1.md#getcomponent)

***

### getComponents()

> **getComponents**(): [`EntityComponent`](EntityComponent-1.md)[]
...
[`Entity`](Entity-1.md).[`getComponents`](Entity-1.md#getcomponents)

***

### getControlScheme()

> **getControlScheme**(): [`ControlScheme`](../enumerations/ControlScheme-1.md)
...
[`Entity`](Entity-1.md).[`getDynamicProperty`](Entity-1.md#getdynamicproperty)
...
[`Entity`](Entity-1.md).[`getDynamicPropertyIds`](Entity-1.md#getdynamicpropertyids)
...
[`Entity`](Entity-1.md).[`getDynamicPropertyTotalByteCount`](Entity-1.md#getdynamicpropertytotalbytecount)

***

### getEffect()

> **getEffect**(`effectType`): [`Effect`](Effect-1.md) \| `undefined`
...
[`Entity`](Entity-1.md).[`getEffect`](Entity-1.md#geteffect)

***

### getEffects()

> **getEffects**(): [`Effect`](Effect-1.md)[]
...
[`Entity`](Entity-1.md).[`getEffects`](Entity-1.md#geteffects)

***

### getEntitiesFromViewDirection()

> **getEntitiesFromViewDirection**(`options?`): [`EntityRaycastHit`](../interfaces/EntityRaycastHit-1.md)[]
...
[`Entity`](Entity-1.md).[`getEntitiesFromViewDirection`](Entity-1.md#getentitiesfromviewdirection)

***

### getGameMode()

> **getGameMode**(): [`GameMode`](../enumerations/GameMode-1.md)
...
> **getHeadLocation**(): [`Vector3`](../interfaces/Vector3-1.md)
...
[`Entity`](Entity-1.md).[`getHeadLocation`](Entity-1.md#getheadlocation)
...
[`Entity`](Entity-1.md).[`getProperty`](Entity-1.md#getproperty)

***

### getRotation()

> **getRotation**(): [`Vector2`](../interfaces/Vector2-1.md)
...
[`Entity`](Entity-1.md).[`getRotation`](Entity-1.md#getrotation)

***

### getSpawnPoint()

> **getSpawnPoint**(): [`DimensionLocation`](../interfaces/DimensionLocation-1.md) \| `undefined`

#### Returns

[`DimensionLocation`](../interfaces/DimensionLocation-1.md) \| `undefined`
...
[`Entity`](Entity-1.md).[`getTags`](Entity-1.md#gettags)
...
> **getVelocity**(): [`Vector3`](../interfaces/Vector3-1.md)
...
[`Entity`](Entity-1.md).[`getVelocity`](Entity-1.md#getvelocity)

***

### getViewDirection()

> **getViewDirection**(): [`Vector3`](../interfaces/Vector3-1.md)
...
[`Entity`](Entity-1.md).[`getViewDirection`](Entity-1.md#getviewdirection)
...
[`Entity`](Entity-1.md).[`hasComponent`](Entity-1.md#hascomponent)
...
[`Entity`](Entity-1.md).[`hasTag`](Entity-1.md#hastag)
...
[`Entity`](Entity-1.md).[`kill`](Entity-1.md#kill)
...
[`Entity`](Entity-1.md).[`lookAt`](Entity-1.md#lookat)
...
[`Entity`](Entity-1.md).[`matches`](Entity-1.md#matches)
...
[`Entity`](Entity-1.md).[`playAnimation`](Entity-1.md#playanimation)
...
[`Entity`](Entity-1.md).[`remove`](Entity-1.md#remove)
...
[`Entity`](Entity-1.md).[`removeEffect`](Entity-1.md#removeeffect)
...
[`Entity`](Entity-1.md).[`removeTag`](Entity-1.md#removetag)
...
[`Entity`](Entity-1.md).[`resetProperty`](Entity-1.md#resetproperty)
...
[`Entity`](Entity-1.md).[`runCommand`](Entity-1.md#runcommand)
...
[`Entity`](Entity-1.md).[`setDynamicProperties`](Entity-1.md#setdynamicproperties)
...
[`Entity`](Entity-1.md).[`setDynamicProperty`](Entity-1.md#setdynamicproperty)
...
[`Entity`](Entity-1.md).[`setOnFire`](Entity-1.md#setonfire)
...
[`Entity`](Entity-1.md).[`setProperty`](Entity-1.md#setproperty)
...
[`Entity`](Entity-1.md).[`setRotation`](Entity-1.md#setrotation)
...
[`Entity`](Entity-1.md).[`teleport`](Entity-1.md#teleport)
...
[`Entity`](Entity-1.md).[`triggerEvent`](Entity-1.md#triggerevent)
...
[`Entity`](Entity-1.md).[`tryTeleport`](Entity-1.md#tryteleport)
