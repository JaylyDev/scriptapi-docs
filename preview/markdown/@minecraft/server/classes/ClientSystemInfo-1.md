...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / ClientSystemInfo
...
[`SystemInfo`](SystemInfo-1.md).[`constructor`](SystemInfo-1.md#constructor)
...
[RawMessage](../interfaces/RawMessage-1.md) with a translate field to send
...
> `readonly` **memoryTier**: [`MemoryTier`](../enumerations/MemoryTier-1.md)
...
[`SystemInfo`](SystemInfo-1.md).[`memoryTier`](SystemInfo-1.md#memorytier)

***

### platformType

> `readonly` **platformType**: [`PlatformType`](../enumerations/PlatformType-1.md)
