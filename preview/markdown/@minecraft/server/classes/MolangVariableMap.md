...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / MolangVariableMap
...
- `<variable_name>.direction_x` - X value from the [Vector3](../interfaces/Vector3.md) provided
- `<variable_name>.direction_y` - Y value from the [Vector3](../interfaces/Vector3.md) provided
- `<variable_name>.direction_z` - Z value from the [Vector3](../interfaces/Vector3.md) provided
...
Adds the following variables to Molang:
- `<variable_name>.x` - X value from the [Vector3](../interfaces/Vector3.md)
provided
- `<variable_name>.y` - Y value from the [Vector3](../interfaces/Vector3.md)
provided
- `<variable_name>.z` - Z value from the [Vector3](../interfaces/Vector3.md)
provided
