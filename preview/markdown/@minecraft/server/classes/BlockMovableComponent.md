...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / BlockMovableComponent
...
> `readonly` **movementType**: [`MovementType`](../enumerations/MovementType.md)
...
> `readonly` **stickyType**: [`StickyType`](../enumerations/StickyType.md)
