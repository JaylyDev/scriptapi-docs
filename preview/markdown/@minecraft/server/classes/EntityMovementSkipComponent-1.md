...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityMovementSkipComponent
...
> `private` **new EntityMovementSkipComponent**(): `EntityMovementSkipComponent`
...
> `readonly` `static` **componentId**: `"minecraft:movement.skip"` = `'minecraft:movement.skip'`
