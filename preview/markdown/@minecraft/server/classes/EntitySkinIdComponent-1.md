...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntitySkinIdComponent
...
> `private` **new EntitySkinIdComponent**(): `EntitySkinIdComponent`
...
> `readonly` `static` **componentId**: `"minecraft:skin_id"` = `'minecraft:skin_id'`
