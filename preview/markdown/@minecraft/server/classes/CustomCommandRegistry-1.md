...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / CustomCommandRegistry
...
(`origin`, ...`args`) => [`CustomCommandResult`](../interfaces/CustomCommandResult-1.md) \| `undefined`
...
[CustomCommandError](CustomCommandError-1.md)
