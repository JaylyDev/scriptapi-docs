...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / DimensionTypes
...
> `static` **get**(`dimensionTypeId`): [`DimensionType`](DimensionType.md) \| `undefined`
...
[`DimensionType`](DimensionType.md) \| `undefined`
...
> `static` **getAll**(): [`DimensionType`](DimensionType.md)[]
