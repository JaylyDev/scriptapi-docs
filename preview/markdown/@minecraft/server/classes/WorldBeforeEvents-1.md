...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / WorldBeforeEvents
...
> `readonly` **chatSend**: [`ChatSendBeforeEventSignal`](ChatSendBeforeEventSignal.md)
...
> `readonly` **effectAdd**: [`EffectAddBeforeEventSignal`](EffectAddBeforeEventSignal-1.md)
...
> `readonly` **entityHeal**: [`EntityHealBeforeEventSignal`](EntityHealBeforeEventSignal-1.md)
...
> `readonly` **entityHurt**: [`EntityHurtBeforeEventSignal`](EntityHurtBeforeEventSignal-1.md)
...
> `readonly` **entityItemPickup**: [`EntityItemPickupBeforeEventSignal`](EntityItemPickupBeforeEventSignal-1.md)
...
> `readonly` **entityRemove**: [`EntityRemoveBeforeEventSignal`](EntityRemoveBeforeEventSignal-1.md)
...
> `readonly` **explosion**: [`ExplosionBeforeEventSignal`](ExplosionBeforeEventSignal-1.md)
...
> `readonly` **itemUse**: [`ItemUseBeforeEventSignal`](ItemUseBeforeEventSignal-1.md)
...
> `readonly` **playerBreakBlock**: [`PlayerBreakBlockBeforeEventSignal`](PlayerBreakBlockBeforeEventSignal-1.md)
...
> `readonly` **playerGameModeChange**: [`PlayerGameModeChangeBeforeEventSignal`](PlayerGameModeChangeBeforeEventSignal-1.md)
...
> `readonly` **playerInteractWithBlock**: [`PlayerInteractWithBlockBeforeEventSignal`](PlayerInteractWithBlockBeforeEventSignal-1.md)
...
> `readonly` **playerInteractWithEntity**: [`PlayerInteractWithEntityBeforeEventSignal`](PlayerInteractWithEntityBeforeEventSignal-1.md)
...
> `readonly` **playerLeave**: [`PlayerLeaveBeforeEventSignal`](PlayerLeaveBeforeEventSignal-1.md)
...
> `readonly` **playerPlaceBlock**: [`PlayerPlaceBlockBeforeEventSignal`](PlayerPlaceBlockBeforeEventSignal.md)
...
event.permutationToPlace; // Permutation of the replaced block.
...
> `readonly` **weatherChange**: [`WeatherChangeBeforeEventSignal`](WeatherChangeBeforeEventSignal-1.md)
