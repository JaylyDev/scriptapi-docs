...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityCanClimbComponent
...
> `private` **new EntityCanClimbComponent**(): `EntityCanClimbComponent`
...
> `readonly` `static` **componentId**: `"minecraft:can_climb"` = `'minecraft:can_climb'`
