...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityCanFlyComponent
...
> `private` **new EntityCanFlyComponent**(): `EntityCanFlyComponent`
...
> `readonly` `static` **componentId**: `"minecraft:can_fly"` = `'minecraft:can_fly'`
