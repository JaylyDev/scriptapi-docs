...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / World
...
> `readonly` **primitiveShapesManager**: [`PrimitiveShapesManager`](PrimitiveShapesManager.md)
...
> **getAimAssist**(): [`AimAssistRegistry`](AimAssistRegistry-1.md)

#### Returns

[`AimAssistRegistry`](AimAssistRegistry-1.md)
