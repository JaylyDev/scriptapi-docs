...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityScaleComponent
...
> `private` **new EntityScaleComponent**(): `EntityScaleComponent`
...
> `readonly` `static` **componentId**: `"minecraft:scale"` = `'minecraft:scale'`
