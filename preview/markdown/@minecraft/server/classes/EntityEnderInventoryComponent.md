...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityEnderInventoryComponent

# Class: EntityEnderInventoryComponent
...
> `private` **new EntityEnderInventoryComponent**(): `EntityEnderInventoryComponent`
...
> `readonly` `static` **componentId**: `"minecraft:ender_inventory"` = `'minecraft:ender_inventory'`
