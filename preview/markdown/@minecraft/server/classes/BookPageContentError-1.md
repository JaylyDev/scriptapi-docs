...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / BookPageContentError

# Class: BookPageContentError

The error called if page content being set on an [ItemBookComponent](ItemBookComponent-1.md) are invalid ie. exceeding the maximum
page length.
