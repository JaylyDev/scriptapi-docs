...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / BlockVolume
...
> **from**: [`Vector3`](../interfaces/Vector3.md)
...
> **to**: [`Vector3`](../interfaces/Vector3.md)
...
> **intersects**(`other`): [`BlockVolumeIntersection`](../enumerations/BlockVolumeIntersection.md)
