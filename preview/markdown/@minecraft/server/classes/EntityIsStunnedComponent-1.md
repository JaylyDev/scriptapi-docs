...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityIsStunnedComponent
...
> `private` **new EntityIsStunnedComponent**(): `EntityIsStunnedComponent`
...
> `readonly` `static` **componentId**: `"minecraft:is_stunned"` = `'minecraft:is_stunned'`
