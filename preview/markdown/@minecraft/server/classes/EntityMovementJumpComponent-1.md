...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / EntityMovementJumpComponent
...
> `private` **new EntityMovementJumpComponent**(): `EntityMovementJumpComponent`
...
> `readonly` `static` **componentId**: `"minecraft:movement.jump"` = `'minecraft:movement.jump'`
