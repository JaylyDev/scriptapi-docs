...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / EntitySwingSource

# Enumeration: EntitySwingSource

Enumerator describing the source of an Entity swing. Sent as
part of [PlayerSwingStartAfterEvent](../classes/PlayerSwingStartAfterEvent.md)
