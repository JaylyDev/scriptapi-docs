...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / TickingAreaErrorReason
...
limit specified by [TickingAreaManager.maxChunkCount](../classes/TickingAreaManager-1.md#maxchunkcount).
...
in the [TickingAreaManager](../classes/TickingAreaManager-1.md).
