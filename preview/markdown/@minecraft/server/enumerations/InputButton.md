...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README.md) / InputButton

# Enumeration: InputButton

All the different input buttons that are supported. Use with
[InputInfo.getButtonState](../classes/InputInfo.md#getbuttonstate) via [Player.inputInfo](../classes/Player.md#inputinfo) or [PlayerButtonInputAfterEvent](../classes/PlayerButtonInputAfterEvent.md) via
[WorldAfterEvents.playerButtonInput](../classes/WorldAfterEvents.md#playerbuttoninput)
