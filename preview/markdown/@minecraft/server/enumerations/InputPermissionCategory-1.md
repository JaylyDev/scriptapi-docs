...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server](../README-1.md) / InputPermissionCategory

# Enumeration: InputPermissionCategory

Input permission categories. Used by [PlayerInputPermissionCategoryChangeAfterEvent](../classes/PlayerInputPermissionCategoryChangeAfterEvent-1.md) to specify
which category was changed and [PlayerInputPermissions](../classes/PlayerInputPermissions-1.md) to get or set permissions.
