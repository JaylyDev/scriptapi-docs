...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server-editor](../README.md) / IRootPropertyPane
...
> `readonly` **drawerPane**: [`IPropertyPane`](IPropertyPane.md)
...
[`IPropertyPane`](IPropertyPane.md).[`id`](IPropertyPane.md#id)
...
[`IPropertyPane`](IPropertyPane.md).[`visible`](IPropertyPane.md#visible)
...
> **createModalOverlayPane**(`options?`): [`IModalOverlayPane`](IModalOverlayPane.md)
