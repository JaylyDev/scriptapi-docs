...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server-editor](../README.md) / IDataTablePropertyItemOptions
...
> `optional` **entries?**: [`IDataTablePropertyItemEntry`](IDataTablePropertyItemEntry.md)[][]
