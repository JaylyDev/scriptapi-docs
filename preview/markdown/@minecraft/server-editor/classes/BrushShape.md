...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server-editor](../README.md) / BrushShape
...
> `abstract` **createSettingsPane**(`parentPane`, `onSettingsChange?`, `flatLayout?`): [`ISubPanePropertyItem`](../interfaces/ISubPanePropertyItem.md) \| `undefined`
