...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server-gametest](../README.md) / SimulatedPlayer
...
The player's chat display name, composed from Player.chatNamePrefix + Player.name + Player.chatNameSuffix. This is the name shown as the author
of chat messages sent by this player. To change the name
shown above the player's head, use [Entity.nameTag](#nametag).
...
`minecraftserver.Player.chatDisplayName`
...
name shown in chat, or [Entity.nameTag](#nametag) for the name
...
`minecraftserver.Player.chatMessagePrefix`
...
above the player's head or the player list - use Entity.nameTag for that. To prefix the message text itself,
...
`minecraftserver.Player.chatNamePrefix`
...
player's name in chat messages. Does not affect the name tag
above the player's head or the player list - use Entity.nameTag for that. See also Player.chatNamePrefix. Set to undefined to clear.
...
`minecraftserver.Player.chatNameSuffix`
...
> `readonly` **locatorBar**: [`LocatorBar`](../../server/classes/LocatorBar.md)
...
`minecraftserver.Player.locatorBar`
...
`minecraftserver.Player.nameplateDepthTested`
...
`minecraftserver.Player.nameplateRenderDistance`
...
> `readonly` `optional` **partyInfo?**: [`PartyInfo`](../../server/interfaces/PartyInfo.md)
...
`minecraftserver.Player.partyInfo`
...
> **addItem**(`itemStack`): [`ItemStack`](../../server/classes/ItemStack.md) \| `undefined`
...
[ContainerRulesError](../../server/classes/ContainerRulesError.md)

Error

[InvalidEntityComponentError](../../server/classes/InvalidEntityComponentError.md)
...
[`Player`](../../server/classes/Player.md).[`addItem`](../../server/classes/Player.md#additem)
...
[`Player`](../../server/classes/Player.md).[`getAimAssist`](../../server/classes/Player.md#getaimassist)
