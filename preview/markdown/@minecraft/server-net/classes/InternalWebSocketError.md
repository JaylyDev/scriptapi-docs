...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server-net](../README.md) / InternalWebSocketError

# Class: InternalWebSocketError
...
> `private` **new InternalWebSocketError**(): `InternalWebSocketError`
