...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server-ui](../README-1.md) / Observable
...
> **getFilteredText**(`this`, `player`): `Promise`\<`string` \| [`TextFilteringError`](../enumerations/TextFilteringError.md)[]\>
...
`Promise`\<`string` \| [`TextFilteringError`](../enumerations/TextFilteringError.md)[]\>
