...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server-ui](../README-1.md) / ModalFormData
...
> **show**(`player`): `Promise`\<[`ModalFormResponse`](ModalFormResponse-1.md)\>
...
`Promise`\<[`ModalFormResponse`](ModalFormResponse-1.md)\>
