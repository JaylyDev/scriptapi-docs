...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server-ui](../README.md) / MessageFormData
...
> **show**(`player`): `Promise`\<[`MessageFormResponse`](MessageFormResponse.md)\>
...
`Promise`\<[`MessageFormResponse`](MessageFormResponse.md)\>
