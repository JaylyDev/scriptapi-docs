...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server-ui](../README.md) / ActionFormData
...
> **show**(`player`): `Promise`\<[`ActionFormResponse`](ActionFormResponse.md)\>
...
`Promise`\<[`ActionFormResponse`](ActionFormResponse.md)\>
