...
[Script API - v1.26.20.28](../../../packages.md) / [@minecraft/server-ui](../README-1.md) / ModalFormDataTextFieldOptions
...
> `optional` **defaultValue?**: `string` \| [`RawMessage`](../../server/interfaces/RawMessage.md)
