...
```
- Requires **v2.8.0-beta** up to, but not including, v3.0.0
```json
{
  "module_name": "@minecraft/server",
  "version": "2.8.0-beta"
...
```bash
npm i @minecraft/server-ui@2.1.0-beta.1.26.20-preview.28
```
...
- [DataDrivenScreenClosedReason](enumerations/DataDrivenScreenClosedReason.md)
- [FormCancelationReason](enumerations/FormCancelationReason-1.md)
- [FormRejectReason](enumerations/FormRejectReason-1.md)
- [TextFilteringError](enumerations/TextFilteringError.md)
...
- [FormCloseError](classes/FormCloseError.md)
...
- [PlayerLeftError](classes/PlayerLeftError.md)
- [ServerShutdownError](classes/ServerShutdownError.md)
